...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT(
        KC_TILD, KC_AMPR, KC_ASTR, XXX, XXX, XXX, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, 
        LGUI_T(KC_BACKSLASH), LALT_T(KC_GRV), LCTL_T(KC_SCLN), LSFT_T(KC_QUOTE), KC_PLUS, XXX, LSFT_T(KC_LBRC), LCTL_T(KC_RBRC), LALT_T(KC_MINS), LGUI_T(KC_EQL), 
        KC_EXLM, KC_HASH, KC_AT, KC_DQT, KC_PIPE, XXX, KC_LT, KC_GT, KC_ALGR, KC_QUES, 
